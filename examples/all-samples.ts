...
async function main() : Promise<void> {
  ...
  const settings: FiscalapiSettings = {
    apiUrl: 'https://localhost:7173', // URL de la API de FiscalAPI
    apiKey: 'sk_development_833a58f9_8212_43ce_b544_f2fa93b1e895', // API key de FiscalAPI
    tenant: 'e839651d-1765-4cd0-ba7f-547a4c20580f', // Tenant de FiscalAPI
    debug:true
  };
